...
public class TnoticeQuery extends DwzPageQuery implements Serializable {
  ...
  //date formats
	...
	public String getCreateTimeBeginString() {
		return DateConvertUtils.format(getCreateTimeBegin(), Tnotice.FORMAT_CREATE_TIME);
	}
	...
	public void setCreateTimeBeginString(String value) {
		setCreateTimeBegin(DateConvertUtils.parse(value, Tnotice.FORMAT_CREATE_TIME,java.util.Date.class));
	}
	...
	public String getCreateTimeEndString() {
		return DateConvertUtils.format(getCreateTimeEnd(), Tnotice.FORMAT_CREATE_TIME);
	}
	...
	public void setCreateTimeEndString(String value) {
		setCreateTimeEnd(DateConvertUtils.parse(value, Tnotice.FORMAT_CREATE_TIME,java.util.Date.class));
	}
	...
	static public String getSortColumns(String orderField,String orderDirection){
		if(StringUtils.isNotBlank(orderField)){
			...
			if(orderField.equals("noticeId")){
				orderColumns.append("notice_id");
			}
			if(orderField.equals("noticeName")){
				orderColumns.append("notice_name");
			}
	...
	public String getParamString(){
		...
		if(noticeId != null){
			str.append("&noticeId=").append(noticeId);
		}
		if(noticeName != null){
			str.append("&noticeName=").append(noticeName);
		}
