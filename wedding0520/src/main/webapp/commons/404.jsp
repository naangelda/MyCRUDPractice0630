...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="./400.gif" />
...
<body class="login">
  <div class="error_page">
    ...
    <h1>We're sorry...</h1>
    <p>The page or journal you are looking for cannot be found.(404-你懂的)</p>
    <p><a href="${ctx}">Return to the homepage</a></p>
  </div>
</body>
</html>
